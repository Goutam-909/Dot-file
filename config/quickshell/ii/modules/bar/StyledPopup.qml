...
LazyLoader {
    ...
    component: PanelWindow {
        ...
        // Add safety check properties
        property bool canMapCoordinates: root.QsWindow && root.hoverTarget &&
        root.hoverTarget.Window.window &&
        popupWindow.visible

        margins {
            left: {
                if (!Config.options.bar.vertical) {
                    if (popupWindow.canMapCoordinates) {
