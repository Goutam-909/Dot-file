    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ColumnLayout {
                ...
                ConfigSelectionArray {
                    currentValue: Config.options.sidebar.websearch.enable ? 1 : 0
                    onSelected: newValue => {
                        Config.options.sidebar.websearch.enable = (newValue === 1);
                    }
                    options: [
                        {
            ...
            ColumnLayout {
                ...
                ConfigSelectionArray {
                    currentValue: Config.options.sidebar.wallhaven.enable ? 1 : 0
                    onSelected: newValue => {
                        Config.options.sidebar.wallhaven.enable = (newValue === 1);
                    }
                    options: [
                        {
                            displayName: "Disabled",
